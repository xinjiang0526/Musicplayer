...
//下载成功时将前台服务通知关闭，并创建一个下载成功的通知
            ...
            getNotificationManager().notify(1,getNotification("下载成功",
                    -1));
            Toast.makeText(DownloadService.this,"下载成功",
        ...
        public void onPaused(){
            downloadTask=null;
            Toast.makeText(DownloadService.this,"已暂停下载", Toast.LENGTH_SHORT).
                    show();
        }
        ...
        public void onCanceled(){
            downloadTask=null;
            stopForeground(true);
            Toast.makeText(DownloadService.this,"已取消下载", Toast.LENGTH_SHORT).
                    show();
        }
    };
        ...
        public void cancelDownload() {
            if (downloadTask != null) {
                ...
                if (downloadUrl != null) {
                    ...
                    stopForeground(true);
                    Toast.makeText(DownloadService.this, "已取消下载",
                            Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private Notification getNotification(String title, int progress){
        Intent intent= new Intent(this,OnlineMusic.class);
